...
public class MessagingConfiguration {
    ...
    @Bean
    Queue queueStart() {
        return QueueBuilder.durable("queue.tracker.echo.start").build();
    }
    ...
    Queue queueWorkerCallback() {
        return QueueBuilder.durable("queue.tracker.echo.worker.callback").build();
    }
    ...
    Queue queueMergeCallback() {
        return QueueBuilder.durable("queue.tracker.echo.merge.callback").build();
    }
